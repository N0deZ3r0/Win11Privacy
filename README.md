...
| Изменения — что программа поменяла и как вернуть |
|---|
| <img src="docs/changes.png" alt="Изменения"> |
...
| **MainForm.cs** | Окно, двенадцать страниц, запуск движка, разбор его ответов, отчёт HTML, режим командной строки. |
