...
| Автозапуск — что стартует вместе с Windows |
|---|
| <img src="docs/startup.png" alt="Автозапуск"> |
...
| **MainForm.cs** | Окно, одиннадцать страниц, запуск движка, разбор его ответов, отчёт HTML, режим командной строки. |
...
| **Lang.cs** | Английский перевод интерфейса. Собирается из `lang-en*.txt` командой `python tools/gen_lang.py` — правьте словари, а не сам Lang.cs. |
