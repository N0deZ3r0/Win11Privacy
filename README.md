...
Интерфейс на русском и английском. Язык берётся из настроек Windows и переключается
кнопкой на странице «О программе». Названия отдельных настроек внутри модулей пока
только на русском — они видны при раскрытии модуля.
