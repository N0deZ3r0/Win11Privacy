...
| **Видно, сколько проверок пройдено** | Проверка 191 настройки занимает до полуминуты и раньше молчала до самого конца. Теперь движок сообщает ход работы, а окно показывает «15 / 34» и название текущего раздела. |
