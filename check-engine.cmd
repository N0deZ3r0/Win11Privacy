...
echo [6/7] Testovyy progon primeneniya (nichego ne menyaet)...
...
echo [7/7] Avtozagruzka: chto startuet vmeste s Windows...
powershell -NoProfile -ExecutionPolicy Bypass -File "%ENG%" -ListStartup > "%~dp0result-startup.json" 2>&1
